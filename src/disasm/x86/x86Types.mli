...
type instruction_kind =
  ...
  | LoadFarPointer of mode * segment_reg * reg32 * address
  | Enter of mode * int * int
  | Leave of mode
  | CMovcc of sizeMode * cc * genop32 * genop32
  | CBW of mode
  | CWD of mode
  | Cmps of rep * sizeMode
  ...
  | Movs of rep * sizeMode
  | Lods of rep * sizeMode
  | Stos of rep * sizeMode
  | Scas of rep * sizeMode
  ...
  | Pmaddusbsw of xmm_mm * simd_size * genopxmm * genopxmm
  ...
  | Pavgusb of xmm_mm * simd_size * genopxmm * genopxmm
  | Pmulhw of xmm_mm * simd_size * genopxmm * genopxmm
  | Pmulhrw of xmm_mm * simd_size * genopxmm * genopxmm
